...
public class review extends AppCompatActivity {
            ...
            ok.setOnClickListener(new View.OnClickListener() {
                public void onClick(View arg0) {
                    ...
                    if(isPressed) {
                        ...
                        disableSend();
                        Intent myIntent = new Intent(review.this, PopupSolveCard.class);
                    ...
                    if(i<5){
                        ...
                        Intent myIntent = new Intent(review.this, reviewscore.class);
                        myIntent.putExtra("result", results);
                        myIntent.putExtra("card", card);
                        myIntent.putExtra("cods", cods);
                        startActivity(myIntent);
                    }
                }
            });
    ...
    private void getWordsEN(int card, int card_real){
        ...
        mWords = new Read().getWordsEN(card_real);
    ...
    private void getWordsENReview(int c){
        TextView englishWord = (TextView) findViewById(R.id.englishword);
        numberOfButton = rand.nextInt(6);
        ...
        ArrayList<WordEN> mWords = new Read().getWordsENReview();

        wordsEN = mWords.get(c);
        englishWord.setText(wordsEN.getNome());
        englishTranslate.setText(wordsEN.getTranslate());
    ...
    private void getWordsPT(){
        ...
        int y=0;
        String buttonID;
        ArrayList<WordPT> mWords = new Read().getWordsPTReview();
